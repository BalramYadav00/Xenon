          ...
          <div className="py-24 lg:py-32">
            <div className="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
              ...
              <p className="mt-6 text-xl text-warm-gray-500 max-w-3xl">
                Greeting, Here you can found how to contact us for any kind of
                service you can reach us 24/7. We are always here to help you.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative bg-white shadow-xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                <div className="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-green-400 to-teal-600 sm:px-10 xl:p-12">
                  <div
